...
const _addAdmonitions = (content, beforeIndent, afterIndent) => {

    return admonitions.add(content, beforeIndent, afterIndent);
...
const _toRawContent = (filepath) => {
    ...
    if (this._theme.admonitions.enabled !== undefined && this._theme.admonitions.enabled === true) {
        ...
        try {
            content = _addAdmonitions(content, this._theme.admonitions.beforeIndent, this._theme.admonitions.beforeIndent);
        } catch (e) {
