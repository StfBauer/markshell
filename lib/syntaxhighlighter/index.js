...
const _addBackground = (source, originalSource) => {
    ...
    // console.log('Origin Lines', originalSourceLines.length);
    // console.log('Columns:', termColumns);

    // FIX for cut in between ...
    for (let i = 0; i < sourceLines.length; i++) {

        // console.log('sourceLines ::::::::::: ', sourceLines[i]);
        // console.log(sourceLines[i].length);
        // console.log('originalSourceLines ::: ', originalSourceLines[i]);
        // console.log(originalSourceLines[i].length);
        ...
        // console.log('Fill Count :::', fill2end);
        ...
        // console.log('END', '.'.repeat(process.stdout.columns - 4));
        // console.log('\n\n');
